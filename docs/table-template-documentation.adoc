...
=== Special functions and variables available in Code and VID Overlays
...
=== Table Actors and Variable useful in your Red program
...
----
USAGE:
     <table-name>/ACTORS/APPEND-ROW face

DESCRIPTION: 
     Appends a new row to the table.
     <table-name>/ACTORS/APPEND-ROW is a function! value.
----

===== Appending a Column to the Table
[source,red]
----
USAGE:
     <table-name>/ACTORS/APPEND-COLUMN face

DESCRIPTION: 
     Appends a new column to the table.
     <table-name>/ACTORS/APPEND-COLUMN is a function! value.
----
